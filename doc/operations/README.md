...
Các tài liệu trong thư mục này lưu trạng thái phát triển và bằng chứng vận hành, không mô tả quy định nghiệp vụ.

- `progress.md`: trạng thái đã xác minh và nhật ký phiên.
- `session-handoff.md`: việc đang dở, blocker và bước tiếp theo.
...
- `mem0-memory.md`: kiến trúc, cách bật và giới hạn an toàn của long-term memory Mem0.
